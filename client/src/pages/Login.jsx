...
function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0f172a] text-white px-4">
      <div className="w-full max-w-md bg-[#1e293b] p-6 sm:p-10 rounded-2xl shadow-2xl border border-white/10">
        {/* Title */}
        <div className="text-center mb-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-orange-400">
            Admin Login
          </h2>
          <p className="text-gray-400 text-sm mt-1">Access dashboard</p>
        </div>
